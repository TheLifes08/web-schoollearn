...
$include_scripts = array("jquery-3.1.0.min.js", "main_script.js", "login_script.js");

require_once $href_main."include/db.php";
$title = "Авторизация$title_postfix";
...
<section class="section_block_log">

<div id="login_content">
	<span class="center">
		<span id="login_text">
			<span class="center"><h1 id="h1_login_text">Вход</h1></span>
		</span>
	</span>
	
	<span class="center">
	<div name="login_form" id="login_form">
		<input type="text" name="log_email" class="input_form_login" placeholder="Email"/><br />
		<input type="password" name="log_pass" class="input_form_login" placeholder="Пароль"/><br />
		<input type="button" name="done" id="input_form_login_button" value="Войти" />
	</div>
	</span>
</div>

<span class="center">
	<div style="display: none;" id="login_message"></div>
</span>
